...
#define J2_SM_ENABLE_A			19
#define J2_SM_ENABLE_B			20
#define J2_SM_A					17
#define J2_SM_B					18

#define SM_ACCEL_TABLE_SIZE     (50)
#define SM_MASTER_CHANNEL		(12)  // this is in eTPU channel numbers
#define SM_ENABLE_CHANNEL		(14)  // this is in eTPU channel numbers
...
public:
	...
	unsigned int GetDesiredPosition(void);
